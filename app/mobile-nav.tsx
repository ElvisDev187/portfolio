...
export default function MobileNav({
  ...
  return (
    <motion.nav
      ...
      custom={height}
      className={`flex z-10 justify-end w-full sm:hidden ${
        isOpen ? "" : "pointer-events-none"
      }`}
      ref={containerRef}
    >
      <motion.div
        className="absolute inset-0 top-20 left-0 w-full dark:bg-gray-900 bg-white z-40"
        variants={sidebar}
      />
      <motion.ul
        variants={variants}
        className="absolute inset-0 grid w-full gap-3 py-16 z-40 "
      >
